  ...
  <div class="container">
    ...
    <div class="d-flex justify-content-center align-content-center flex-row">
      <div class="card p-4 mt-3 mr-4  shadow">
        <form style="width: 350px" @submit.prevent="onSubmit">
          <div class="form-group">
            ...
            <input v-model="email" type="email" class="form-control" placeholder="E-posta adresini giriniz">
          ...
          <ul class="list-group mt-3 mb-3 border-0">
            <li v-for="(hobby,index) in hobbies" :key="hobby.index" class="list-group-item d-flex pl-2">
      ...
      <div class="card p-4 mt-3 shadow" style="width: 400px">
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quod consectetur vero fugiat nobis aliquam quidem distinctio aspernatur aliquid odio porro itaque ad repellat, veritatis omnis eius ab nisi rem ea architecto odit mollitia, suscipit harum possimus! Voluptates aliquid aperiam animi dolor, dolore, suscipit hic laudantium reiciendis consequuntur, non omnis impedit!</p>
      </div>
    </div>
  </div>
</template>
