...
export default {
  // computed : {
    //başka getter kullanmayacaksak direkt aşağıdaki gibi kullanabiliriz
  // }

//ne kadar getters varsa buraya getirecek, array içinde bir tane var onu kullan diyoruz, şimdi template de gereken yerlere bunu yazacağız
